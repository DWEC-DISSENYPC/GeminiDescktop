...
![Gemini Desktop](https://img.shields.io/badge/Gemini-Desktop%20Client-7a9efd?style=for-the-badge&logo=google&logoColor=white)
...
**Aplicación de escritorio nativa y ligera para Google Gemini AI en Windows.**  
...
> Interfaz oscura tipo *Glassmorphism* con barra de pestañas personalizada, controles nativos de ventana y gestor de perfiles integrado, estilo Google Gemini.

```
┌─────────────────────────────────────────────────────────────────────┐
│ ✦ Gemini  │ Pestaña 1 │ Pestaña 2 │ Pestaña 3 │ +   [👤 Perfil] [─][□][✕]│
├─────────────────────────────────────────────────────────────────────┤
│ ← →  ↻   🔒 https://gemini.google.com              [-] [100%] [+]  │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│                  ✦  Gemini  (Interfaz Web Real)                     │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
|---|---|
| 🗂️ **Multi-Pestaña** | Abre hasta 4 pestañas simultáneas de Gemini, todas vinculadas a la misma sesión activa |
...
| 🎨 **Diseño Premium** | Interfaz oscura *Glassmorphism* con animaciones suaves y tipografía *Outfit* de Google Fonts |
| 🔲 **Ventana Sin Marco** | Barra de título completamente personalizada con controles nativos de Windows |
| 🔗 **Links Externos Seguros** | Los enlaces ajenos a Gemini/Google se abren automáticamente en el navegador por defecto |
...
3. Una vez compilado, haz doble clic en `Iniciar.bat` o ejecuta directamente:
   ```
   dist\GeminiDesktop-win32-x64\GeminiDesktop.exe
   ```
...
git clone https://github.com/DWEC-DISSENYPC/gemini-desktop-client.git
...
> Puedes copiar la carpeta completa `GeminiDesktop-win32-x64` a cualquier PC con Windows y la aplicación funcionará de forma autónoma.
...
- **Eliminar un perfil**: Abre *Gestionar perfiles* y pulsa *Eliminar* junto al perfil que deseas borrar.
...
├── styles.css        # Sistema de diseño CSS (Dark mode, Glassmorphism, animaciones)
...
- **CSS Variables & Glassmorphism** — Sistema de diseño moderno con tema oscuro nativo de Gemini.
...
| **Conexión a Internet** | Requerida para acceder a Gemini |
